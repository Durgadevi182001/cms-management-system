...
?>					
	...
	while($rssubject = mysqli_fetch_array($qsqlsubject))
	{
		echo "<th><input tabindex='$tabindex' type='text' name='intmaxmark[$rssubject[subjectid]]'  id='intmaxmark[$rssubject[subjectid]]' style='width:100px;' value='0'  onkeyup='calculateintgrandtot()'><input type='hidden' name='subjectidz[$icount]' id='subjectidz[$icount]' value='$rssubject[subjectid]'></th>";
		$icount=$icount+1;
		$tabindex=$tabindex+1;
	}
	?> 
		<th><input type="text"  style="width:100px;"  name="maxintgrandtot" id="maxintgrandtot" readonly ></th>
		<th></th>
		<th></th>
	</tr>
<?php
...
?>					
	...
	while($rssubject = mysqli_fetch_array($qsqlsubject))
	{
		echo "<th><input tabindex='$tabindex' type='text' name='intmaxmark[$rssubject[subjectid]]' style='width:100px;' id='intmaxmark[$rssubject[subjectid]]' value='0'   onkeyup='calculateintgrandtot()'><input type='hidden' name='subjectidz[$icount]' id='subjectidz[$icount]' value='$rssubject[subjectid]'></th>";
		$icount=$icount+1;
		 $tabindex=$tabindex+1;
	}
	?>
		<th><input type="hidden" value="0" name="maxintgrandtot" id="maxintgrandtot" readonly ></th>
		<th></th>
		<th></th>
	</tr>
<?php
...
?>
			...
			<?php
				...
				while($rssubject = mysqli_fetch_array($qsqlsubject))
				{							
echo "<th><input type='text' tabindex='$tabindex' name='extmaxmark[$rssubject[subjectid]]' style='width:100px;' id='extmaxmark[$rssubject[subjectid]]' value='0' onkeyup='calculateextgrandtot()'><input type='hidden' name='subjectidzz[$icount]' id='subjectidzz[$icount]' value='$rssubject[subjectid]'></th>";
$icount=$icount+1; $tabindex=$tabindex+1;
				}
				?>
				<th><input type="text" style="width:100px;" name="maxextgrandtot" id="maxextgrandtot" readonly ></th>
				<th></th>
				<th></th>
			</tr>
<?php
...
while($rssubject = mysqli_fetch_array($qsqlsubject))
{
	...
	if($_GET[examtype] != "Semester")
	{
		echo "<input type='text' tabindex='$tabindex'  name='intmark[$rs[studentid]][$rssubject[0]]' id='intmark[$rs[studentid]][$rssubject[0]]'   style='width:100px;' value='0' required onkeyup='calculatemarks($rs[studentid])'>
		<input type='hidden' name='extmark[$rs[studentid]][$rssubject[0]]'>";
		$tabindex=$tabindex+1;
	}
	if($_GET[examtype] == "Semester")
	{
	...
	if($_GET[examtype] == "Semester")
	{
		echo "<input type='text' tabindex='$tabindex' name='extmark[$rs[studentid]][$rssubject[0]]' id='extmark[$rs[studentid]][$rssubject[0]]' style='width:100px;' onkeyup='calculateextmarks($rs[studentid])' value='0' required  >";
		 $tabindex=$tabindex+1;
	}
	echo "</td>";
}
 echo "<td><input type='hidden' name='totalint[$rs[studentid]]' id='totalint[$rs[studentid]]'  value='0'><input type='text' name='total[$rs[studentid]]' id='total[$rs[studentid]]'  style='width:100px;background-color:white;color:black;' readonly value='0'></td>
 <td><input type='text' name='percentage[$rs[studentid]]' id='percentage[$rs[studentid]]'  style='width:100px;background-color:white;color:black;' readonly value='0%'></td>
 <td><input type='text' name='grade[$rs[studentid]]' id='grade[$rs[studentid]]'  style='width:200px;background-color:white;color:black;' readonly></td>";
						echo "</tr>";
					}
?>
</table>
...
{
	window.location='examresult.php?courseid='+ courseid +'&semesterid='+semesterid;
}
function loadexamtype(courseid,semesterid,examtype)
{
	window.location='examresult.php?courseid='+ courseid +'&semesterid='+semesterid+'&examtype='+examtype;
}
</scripT>
<script>
