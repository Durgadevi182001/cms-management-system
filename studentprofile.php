		...
		<div class="container">
			<div class="col-md-7 book-appointment">
				...
				<form action="" method="post" enctype="multipart/form-data" >
					...
					<div class="gaps">
						<p>Course</p>
						<input type="text" name="courseid" value="<?php echo $rsedit[course]; ?>" placeholder="Enter the course" />
					</div>
					<div class="gaps">
						<p>Semester</p>
						<input type="text" name="semesterid" value="<?php echo $rsedit[semesterid]; ?>" placeholder="Enter the semester" />
					</div>
