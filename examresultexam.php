...
while($rssubject = mysqli_fetch_array($qsqlsubject))
{
	...
	if($_GET[examtype] != "Semester")
	{
		echo "<input type='text' tabindex='$tabindex' readonly name='intmark[$rs[studentid]][$rssubject[0]]' id='intmark[$rs[studentid]][$rssubject[0]]'   style='width:100px;' value='$rsexam_result[scoredinternalmark]' required onkeyup='calculatemarks($rs[studentid])'>
