...
<p>Course</p>
			<select name="courseid" onchange="window.location='attendancestudentattendance.php?courseid='+courseid.value+'&semesterid='+semesterid.value+'&subjectid='+subjectid.value+'&attendancedate='+attendancedate.value">
...
<div class="col-md-3 gaps">
	<p>Semester</p>
	<select name="semesterid" id="semesterid" onchange="window.location='attendancestudentattendance.php?courseid='+courseid.value+'&semesterid='+semesterid.value+'&subjectid='+subjectid.value+'&attendancedate='+attendancedate.value">
	<option value=''>Select</option>
	<?php
...
<div class="col-md-3 gaps">
		<p>Subject</p>
		<select name="subjectid" id="subjectid"  onchange="window.location='attendancestudentattendance.php?courseid='+courseid.value+'&semesterid='+semesterid.value+'&subjectid='+subjectid.value+'&attendancedate='+attendancedate.value">
...
<div class="col-md-3 gaps">
	...
	?>"    onchange="window.location='attendancestudentattendance.php?courseid='+courseid.value+'&semesterid='+semesterid.value+'&subjectid='+subjectid.value+'&attendancedate='+attendancedate.value"/>
</div>
...
?>
					<?php	
						echo "</td><td>$rsattendance[remark]</td></tr>";
$i++;
					}
					?>
				</table>					
